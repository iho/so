...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'question_user', (
            ...
            ('use_avatar', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('username', self.gf('django.db.models.fields.CharField')(default=u'Unnamed', max_length=80, blank=True)),
        ...
        db.create_table(u'question_question', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.User'])),
            ('raiting', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('cat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.Category'], null=True, blank=True)),
        ...
        db.create_table(m2m_table_name, (
            ...
            ('question', models.ForeignKey(orm[u'question.question'], null=False)),
        ...
        db.create_table(u'question_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'answers', to=orm['question.Question'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.User'])),
    ...
    models = {
        ...
        u'question.user': {
            'Meta': {'ordering': "[u'-created']", 'object_name': 'User'},
